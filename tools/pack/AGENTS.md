...
- Release artifacts keep canonical app identity (`Auto Design.app` on mac, `Auto Design.exe` inside the Windows installer); local tools-pack installs may use namespace-scoped install paths only as a developer multi-instance validation convention.
