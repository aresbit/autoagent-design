# Shared option definitions for the Auto Design Home Manager and NixOS
...
in {
  enable = lib.mkEnableOption "Auto Design — local-first design product daemon";
  ...
  package = lib.mkOption {
    ...
    description = "The Auto Design daemon package providing the `od` binary.";
  };
  ...
  webFrontend = {
    # The Auto Design web frontend is a static SPA built by
