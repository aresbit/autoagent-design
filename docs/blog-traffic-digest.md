...
|---|---:|---|---:|---:|---:|---:|
| [The open-source alternative to Claude Design](https://open-design.ai/blog/open-source-alternative-to-claude-design/) | 8d | Guides | 161 | 5 | 3.1% | 7.7 |
| [How to port a Figma workflow into an Auto Design plugin](https://open-design.ai/blog/port-figma-workflow-open-design-plugin/) | 4d | Use cases | 16 | 2 | 12.5% | 9.3 |
| [The layout layer the canvas used to hide](https://open-design.ai/blog/layout-layer-canvas-used-to-hide/) | 4d | Community | 3 | 0 | 0.0% | 6.3 |
| [BYOK reality check: 5 things that break in Auto Design today](https://open-design.ai/blog/byok-reality-check-5-things-that-break/) | 8d | Guides | 0 | 0 | 0.0% | — |
| [31 skills, 72 systems: how the Auto Design library works](https://open-design.ai/blog/31-skills-72-systems-how-the-library-works/) | 9d | Guides | 0 | 0 | 0.0% | — |
| [BYOK design workflow: run Claude, Codex, or Qwen on your own key](https://open-design.ai/blog/byok-design-workflow-claude-codex-qwen/) | 9d | Guides | 0 | 0 | 0.0% | — |
| [Why we built Auto Design as a skill layer, not a product](https://open-design.ai/blog/why-we-built-open-design-as-a-skill-layer/) | 9d | Product | 0 | 0 | 0.0% | — |
