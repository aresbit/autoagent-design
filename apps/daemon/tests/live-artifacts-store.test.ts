...
describe('live artifact store layout', () => {
  ...
  it('maps document refresh data paths directly even when a legacy transform is present', () => {
    const document: any = {
      ...
      dataJson: {
        repository: {
          fullName: 'aresbit/autoagent-design',
          url: 'https://github.com/aresbit/autoagent-design',
          starCount: 100,
      ...
      sourceJson: {
        ...
        input: { url: 'https://api.github.com/repos/aresbit/autoagent-design' },
        outputMapping: {
          dataPaths: [
    ...
    const candidate = buildLiveArtifactRefreshCandidate({
      ...
      documentOutput: {
        output: {
          ...
          full_name: 'aresbit/autoagent-design',
          html_url: 'https://github.com/aresbit/autoagent-design',
