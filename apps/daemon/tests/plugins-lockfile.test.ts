...
const plugin: InstalledPluginRecord = {
  ...
  version: '0.1.0',
  sourceKind: 'github',
  source: 'github:aresbit/autoagent-design@main/plugins/community/registry-starter',
  ...
  resolvedSource: 'github:aresbit/autoagent-design@main/plugins/community/registry-starter',
  resolvedRef: 'main',
