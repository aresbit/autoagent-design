# Auto Design Telemetry Relay

Cloudflare Worker relay for opt-in Auto Design telemetry. The shipped desktop
...
The Worker requires the Auto Design telemetry marker header, validates the
