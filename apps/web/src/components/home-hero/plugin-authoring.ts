...
export const PLUGIN_AUTHORING_PROMPT_TEMPLATE = [
  `Create an Auto Design plugin for: {{${PLUGIN_AUTHORING_GOAL_INPUT}}}.`,
  '',
  ...
  '- **Auto Design PR** — opens a draft PR against `aresbit/autoagent-design` for the community catalog.',
  '',
