...
export const fr: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Si vous avez installé une CLI avec npm ou Homebrew et qu\'elle apparaît toujours comme non installée, vérifiez que le dossier bin de l\'outil est dans le PATH hérité par le daemon Auto Design (le Terminal et les applications graphiques peuvent différer sur macOS). Voir QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Ouvrez Installer ou Documentation pour l\'agent souhaité.',
  'settings.agentInstall.stepAuth':
    'Authentifiez-vous avec la CLI du fournisseur (connexion ou ajout des identifiants API) avant de revenir dans Auto Design.',
  ...
  'settings.mcpServerHint': 'Exposez Auto Design comme serveur MCP pour votre agent de code.',
  ...
  'settings.privacyHint': 'Données partagées avec l’équipe Auto Design',
  'settings.privacyConsentKicker': 'Aidez-nous à améliorer Auto Design',
  'settings.privacyConsentLead': 'Auto Design peut partager des données d’utilisation avec notre équipe pour nous aider à améliorer le produit. Cela inclut :',
  ...
  'entry.githubStarAria': 'Mettre une étoile à Auto Design sur GitHub',
  ...
  'preview.errorBody': 'Le chargement du HTML de l\'exemple a échoué. Vérifiez qu\'Auto Design est en cours d\'exécution et réessayez.',
  ...
  'settings.memoryStarterProjectDesc': 'Auto Design v0.5 — éditeur de design piloté par chat',
  ...
  'updater.installerOpenBody': 'Le programme d’installation est ouvert. Quittez Auto Design avant de remplacer l’application.',
  ...
  'updater.quitButton': 'Quitter Auto Design',
  'updater.quitFailedBody': 'Auto Design n’a pas pu quitter.',
  ...
  'updater.readyVersion': 'Auto Design {version} est prêt.',
  ...
  'settings.mcpHint':
    'Permet à un agent de code dans un autre dépôt (Claude Code, Cursor, VS Code, Antigravity, Zed, Windsurf) de lire vos projets Auto Design. Utilisez-le pour intégrer un design dans votre app sans exporter d’abord un zip.',
  'settings.mcpDaemonError':
    'Impossible de joindre le daemon local pour résoudre les chemins d’installation ({error}). Vérifiez qu’Auto Design fonctionne, puis rouvrez ce panneau.',
  ...
  'settings.mcpCapabilityDefault':
    'Utiliser par défaut le projet et le fichier ouverts dans Auto Design, afin que vous puissiez dire « intègre ce design dans mon application » sans repréciser quel design.',
  'settings.mcpRunningNote':
    'Auto Design doit être lancé pour que les appels d’outils MCP réussissent. Si vous avez démarré votre agent de code avant d’ouvrir Auto Design, redémarrez l’agent pour qu’il puisse joindre le daemon actif.',
