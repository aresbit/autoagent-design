...
export const uk: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Якщо ви встановили CLI через npm або Homebrew, але вона все ще відображається як не встановлена, переконайтеся, що bin-каталог інструмента є у PATH, який успадковує daemon Auto Design (у macOS PATH у Terminal і GUI-застосунків може відрізнятися). Див. QUICKSTART.md (розділ "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Відкрийте Встановити або Документація для потрібного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдіть автентифікацію у CLI постачальника (увійдіть або додайте API-облікові дані), потім поверніться до Auto Design.',
  ...
  'settings.mcpServerHint': 'Відкрийте Auto Design як MCP-сервер для вашого кодинг-агента.',
  ...
  'entry.githubStarAria': 'Поставити Auto Design зірку на GitHub',
  ...
  'preview.errorBody': 'Не вдалося отримати HTML прикладу. Переконайтеся, що Auto Design запущено, і повторіть спробу.',
  ...
  'updater.installerOpenBody': 'Інсталятор відкрито. Закрийте Auto Design перед заміною застосунку.',
  ...
  'updater.quitButton': 'Закрити Auto Design',
  'updater.quitFailedBody': 'Не вдалося закрити Auto Design.',
  ...
  'updater.readyVersion': 'Auto Design {version} готовий.',
