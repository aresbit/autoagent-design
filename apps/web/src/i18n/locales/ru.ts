...
export const ru: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Если вы установили CLI через npm или Homebrew, но она всё ещё отмечена как не установленная, убедитесь, что bin-каталог инструмента есть в PATH, который наследует daemon Auto Design (в macOS PATH у Terminal и GUI-приложений может отличаться). См. QUICKSTART.md (раздел "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Откройте Установить или Документация для нужного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдите аутентификацию в CLI поставщика (вход или добавление API-ключей), затем вернитесь в Auto Design.',
  ...
  'settings.mcpServerHint': 'Откройте Auto Design как MCP-сервер для вашего кодинг-агента.',
  ...
  'entry.githubStarAria': 'Поставить Auto Design звезду на GitHub',
  ...
  'preview.errorBody': 'Не удалось получить HTML примера. Убедитесь, что Auto Design запущен, и повторите попытку.',
  ...
  'updater.installerOpenBody': 'Установщик открыт. Закройте Auto Design перед заменой приложения.',
  ...
  'updater.quitButton': 'Закрыть Auto Design',
  'updater.quitFailedBody': 'Не удалось закрыть Auto Design.',
  ...
  'updater.readyVersion': 'Auto Design {version} готов.',
