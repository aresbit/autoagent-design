...
export const ar: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'إذا ثبّتّ CLI باستخدام npm أو Homebrew وما زال يظهر كغير مثبت، فتأكد من أن مجلد bin للأداة موجود في PATH الذي يرثه daemon الخاص بـ Auto Design (قد يختلف PATH بين Terminal وتطبيقات GUI على macOS). راجع QUICKSTART.md (قسم "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'افتح رابط التثبيت أو الوثائق للوكيل الذي تفضله.',
  'settings.agentInstall.stepAuth':
    'أكمِل المصادقة في CLI الخاص بالمزوّد (تسجيل الدخول أو إضافة بيانات اعتماد API) قبل العودة إلى Auto Design.',
  ...
  'settings.mcpServerHint': 'كشف Auto Design كخادم MCP لوكيل البرمجة الخاص بك.',
  ...
  'entry.githubStarAria': 'منح Auto Design نجمة على GitHub',
  ...
  'preview.errorBody': 'فشل جلب HTML الخاص بالمثال. تأكد من تشغيل Auto Design ثم أعد المحاولة.',
  ...
  'updater.installerOpenBody': 'المثبت مفتوح. أغلق Auto Design قبل استبدال التطبيق.',
  ...
  'updater.quitButton': 'إنهاء Auto Design',
  'updater.quitFailedBody': 'تعذر إنهاء Auto Design.',
  ...
  'updater.readyVersion': 'Auto Design {version} جاهز.',
