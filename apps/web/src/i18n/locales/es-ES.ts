...
export const esES: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Si instalaste una CLI con npm o Homebrew y sigue apareciendo como no instalada, asegúrate de que el directorio bin de la herramienta esté en el PATH que hereda el daemon de Auto Design (Terminal y apps GUI pueden diferir en macOS). Consulta QUICKSTART.md (sección "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abre Instalar o Docs para el agente que prefieras.',
  'settings.agentInstall.stepAuth':
    'Autentícate con la CLI del proveedor (inicia sesión o añade credenciales API) antes de volver a Auto Design.',
  ...
  'settings.mcpServerHint': 'Expón Auto Design como servidor MCP para tu agente de código.',
  ...
  'entry.githubStarAria': 'Dar una estrella a Auto Design en GitHub',
  ...
  'preview.errorBody': 'No se pudo obtener el HTML del ejemplo. Asegúrate de que Auto Design esté en ejecución e inténtalo de nuevo.',
  ...
  'pet.tabBuiltInHint': 'Compañeros incluidos con Auto Design — elige uno y adóptalo.',
  ...
  'pet.codexBundledTitle': 'Viene con Auto Design — sin descarga.',
  ...
  'updater.installerOpenBody': 'El instalador está abierto. Cierra Auto Design antes de reemplazar la app.',
  ...
  'updater.quitButton': 'Salir de Auto Design',
  'updater.quitFailedBody': 'No se pudo cerrar Auto Design.',
  ...
  'updater.readyVersion': 'Auto Design {version} está listo.',
