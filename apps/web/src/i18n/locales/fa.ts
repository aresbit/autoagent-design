...
export const fa: Dict = {
  ...
  'settings.agentInstall.stepAuth':
    'قبل از بازگشت به Auto Design، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'Auto Design را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'entry.githubStarAria': 'به Auto Design در GitHub ستاره بدهید',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید Auto Design در حال اجراست و دوباره تلاش کنید.',
  ...
  'updater.installerOpenBody': 'نصب‌کننده باز است. پیش از جایگزینی برنامه، Auto Design را ببندید.',
  ...
  'updater.quitButton': 'بستن Auto Design',
  'updater.quitFailedBody': 'Auto Design بسته نشد.',
  ...
  'updater.readyVersion': 'Auto Design {version} آماده است.',
