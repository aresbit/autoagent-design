...
export const id: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Jika Anda memasang CLI dengan npm atau Homebrew tetapi masih tampil sebagai belum terpasang, pastikan direktori bin alat ada di PATH yang diwarisi daemon Auto Design (PATH Terminal dan aplikasi GUI bisa berbeda di macOS). Lihat QUICKSTART.md (bagian "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Buka Instal atau Dokumentasi untuk agen pilihan Anda.',
  'settings.agentInstall.stepAuth':
    'Lakukan autentikasi di CLI vendor (masuk atau tambahkan kredensial API) sebelum kembali ke Auto Design.',
  ...
  'settings.mcpServerHint': 'Ekspos Auto Design sebagai server MCP untuk agen koding Anda.',
  ...
  'entry.githubStarAria': 'Beri star Auto Design di GitHub',
  ...
  'preview.errorBody': 'Pengambilan HTML contoh gagal. Pastikan Auto Design berjalan, lalu coba lagi.',
  ...
  'pet.tabBuiltInHint': 'Pet pilihan yang disertakan dengan Auto Design - pilih satu lalu adopsi.',
  ...
  'pet.codexBundledTitle': 'Disertakan dengan Auto Design - tidak perlu diunduh.',
  ...
  'updater.installerOpenBody': 'Installer sudah terbuka. Tutup Auto Design sebelum mengganti aplikasi.',
  ...
  'updater.quitButton': 'Tutup Auto Design',
  'updater.quitFailedBody': 'Auto Design tidak dapat ditutup.',
  ...
  'updater.readyVersion': 'Auto Design {version} siap.',
