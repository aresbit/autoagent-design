...
export const de: Dict = {
  ...
  'settings.agentInstall.stepAuth':
    'Authentifizieren Sie sich mit der Anbieter-CLI (anmelden oder API-Zugangsdaten setzen), bevor Sie zu Auto Design zurueckkehren.',
  ...
  'settings.mcpServerHint': 'Stelle Auto Design als MCP-Server für deinen Coding-Agent bereit.',
  ...
  'entry.githubStarAria': 'Auto Design auf GitHub einen Stern geben',
  ...
  'preview.errorBody': 'Das Beispiel-HTML konnte nicht abgerufen werden. Stelle sicher, dass Auto Design läuft, und versuche es erneut.',
  ...
  'updater.installerOpenBody': 'Der Installer ist geöffnet. Beenden Sie Auto Design, bevor Sie die App ersetzen.',
  ...
  'updater.quitButton': 'Auto Design beenden',
  'updater.quitFailedBody': 'Auto Design konnte nicht beendet werden.',
  ...
  'updater.readyVersion': 'Auto Design {version} ist bereit.',
