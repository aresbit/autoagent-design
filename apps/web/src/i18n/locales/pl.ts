...
export const pl: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Jeśli zainstalowano CLI przez npm lub Homebrew, ale nadal widnieje jako niezainstalowana, upewnij się, że katalog bin narzędzia jest w PATH dziedziczonym przez daemon Auto Design (na macOS PATH w Terminalu i aplikacjach GUI może się różnić). Zobacz QUICKSTART.md (sekcja "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Otwórz Zainstaluj lub Dokumentacja dla wybranego agenta.',
  'settings.agentInstall.stepAuth':
    'Uwierzytelnij się w CLI dostawcy (zaloguj się lub dodaj dane API), zanim wrócisz do Auto Design.',
  ...
  'settings.mcpServerHint': 'Udostępnij Auto Design jako serwer MCP dla swojego agenta kodu.',
  ...
  'entry.githubStarAria': 'Daj Auto Design gwiazdkę na GitHubie',
  ...
  'preview.errorBody': 'Nie udało się pobrać kodu HTML przykładu. Upewnij się, że Auto Design jest uruchomiony, i spróbuj ponownie.',
  ...
  'updater.installerOpenBody': 'Instalator jest otwarty. Zamknij Auto Design przed zastąpieniem aplikacji.',
  ...
  'updater.quitButton': 'Zamknij Auto Design',
  'updater.quitFailedBody': 'Nie można zamknąć Auto Design.',
  ...
  'updater.readyVersion': 'Auto Design {version} jest gotowy.',
