...
export const ja: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'npm または Homebrew で CLI をインストールしたのに未インストールのまま表示される場合は、Auto Design daemon が引き継ぐ PATH にツールの bin ディレクトリが含まれていることを確認してください（macOS では Terminal と GUI アプリで PATH が異なる場合があります）。QUICKSTART.md（"Local agent CLI and PATH" セクション）を参照してください。',
  'settings.agentInstall.stepOpenLinks': '利用したいエージェントの「インストール」または「ドキュメント」を開きます。',
  'settings.agentInstall.stepAuth':
    'Auto Design に戻る前に、ベンダー CLI で認証（サインインまたは API 資格情報の追加）を行います。',
  ...
  'settings.mcpServerHint': 'Auto Design を MCP サーバーとしてコーディングエージェントに公開します。',
  ...
  'entry.githubStarAria': 'GitHub で Auto Design にスターを付ける',
  ...
  'preview.errorBody': '例の HTML を取得できませんでした。Auto Design が起動していることを確認して再試行してください。',
  'preview.retry': '再試行',
  ...
  'pet.title': 'ペット',
  'pet.tabBuiltIn': '組み込み',
  'pet.tabBuiltInHint': 'Auto Design に同梱された厳選コンパニオン — 選んで迎え入れよう。',
  ...
  'pet.codexBundled': '同梱',
  'pet.codexBundledTitle': 'Auto Design に同梱 — ダウンロード不要。',
  ...
  'updater.installerOpenBody': 'インストーラーが開いています。アプリを置き換える前に Auto Design を終了してください。',
  ...
  'updater.quitButton': 'Auto Design を終了',
  'updater.quitFailedBody': 'Auto Design を終了できませんでした。',
  'updater.quitFailedTitle': '終了できませんでした',
  'updater.quitting': '終了しています...',
  'updater.ready': 'アップデート準備完了',
  'updater.readyGeneric': '新しいバージョンの準備ができました。',
  'updater.readyVersion': 'Auto Design {version} の準備ができました。',
