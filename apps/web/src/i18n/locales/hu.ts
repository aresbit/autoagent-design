...
export const hu: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Ha npm-mel vagy Homebrew-val telepítettél egy CLI-t, de továbbra is nincs telepítve állapotban látszik, ellenőrizd, hogy az eszköz bin könyvtára benne van-e abban a PATH-ban, amit az Auto Design daemon örököl (macOS-en a Terminal és a GUI appok PATH-ja eltérhet). Lásd a QUICKSTART.md "Local agent CLI and PATH" szakaszát.',
  'settings.agentInstall.stepOpenLinks': 'Nyisd meg a Telepítés vagy Dokumentáció hivatkozást a kívánt ügynöknél.',
  'settings.agentInstall.stepAuth':
    'Hitelesíts a szolgáltató CLI-jében (bejelentkezés vagy API hitelesítő adatok megadása), mielőtt visszatérsz az Auto Designhoz.',
  ...
  'settings.mcpServerHint': 'Tedd elérhetővé az Auto Designt MCP-szerverként a kódügynököd számára.',
  ...
  'entry.githubStarAria': 'Csillagozd meg az Auto Design projektet a GitHubon',
  ...
  'preview.errorBody': 'A példa HTML-jének letöltése meghiúsult. Győződj meg róla, hogy az Auto Design fut, majd próbáld újra.',
  'preview.retry': 'Újra',
  ...
  'updater.installerOpenBody': 'A telepítő meg van nyitva. Az alkalmazás cseréje előtt lépjen ki az Auto Designból.',
  ...
  'updater.quitButton': 'Kilépés az Auto Designból',
  'updater.quitFailedBody': 'Az Auto Design nem tudott kilépni.',
  ...
  'updater.readyVersion': 'Az Auto Design {version} elkészült.',
