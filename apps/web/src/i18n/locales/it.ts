...
export const it: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Se hai installato una CLI con npm o Homebrew e appare ancora come non installata, verifica che la cartella bin dello strumento sia nel PATH ereditato dal daemon Auto Design (Terminale e app GUI possono differire su macOS). Vedi QUICKSTART.md (sezione "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Apri Installa o Documentazione per l\'agente desiderato.',
  'settings.agentInstall.stepAuth':
    'Autenticati con la CLI del provider (login o aggiunta delle credenziali API) prima di tornare in Auto Design.',
  ...
  'settings.mcpServerHint': 'Esponi Auto Design come server MCP per il tuo agente di codice.',
  ...
  'settings.privacyHint': 'Quali dati vengono condivisi con il team di Auto Design',
  'settings.privacyConsentKicker': 'Aiutaci a migliorare Auto Design',
  'settings.privacyConsentLead': 'Auto Design può condividere dati di utilizzo con il nostro team per aiutarci a migliorare. Questo include:',
  ...
  'preview.errorBody': 'Il caricamento dell\'HTML dell\'esempio è fallito. Verifica che Auto Design sia in esecuzione e riprova.',
  ...
  'pet.tabBuiltInHint': 'Compagni forniti con Auto Design — scegline uno e adottalo.',
  ...
  'pet.codexBundledTitle': 'Fornito con Auto Design — nessun download necessario.',
  ...
  'settings.memoryStarterProjectDesc': 'Auto Design v0.5 — editor di design guidato da chat',
  ...
  'updater.installerOpenBody': 'Il programma di installazione è aperto. Esci da Auto Design prima di sostituire l’app.',
  ...
  'updater.quitButton': 'Esci da Auto Design',
  'updater.quitFailedBody': 'Auto Design non è riuscito a uscire.',
  ...
  'updater.readyVersion': 'Auto Design {version} è pronto.',
