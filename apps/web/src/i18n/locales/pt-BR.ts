...
export const ptBR: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Se você instalou uma CLI com npm ou Homebrew e ela ainda aparece como não instalada, garanta que o diretório bin da ferramenta esteja no PATH herdado pelo daemon do Auto Design (Terminal e apps GUI podem diferir no macOS). Veja QUICKSTART.md (seção "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abra Instalar ou Docs para o agente desejado.',
  'settings.agentInstall.stepAuth':
    'Autentique-se na CLI do fornecedor (faça login ou adicione credenciais de API) antes de voltar ao Auto Design.',
  ...
  'settings.mcpServerHint': 'Exponha o Auto Design como servidor MCP para o seu agente de código.',
  ...
  'entry.githubStarAria': 'Dar uma estrela ao Auto Design no GitHub',
  ...
  'preview.errorBody': 'A obtenção do HTML do exemplo falhou. Verifique se o Auto Design está em execução e tente novamente.',
  ...
  'pet.tabBuiltInHint': 'Companheiros incluídos no Auto Design — escolha um e adote.',
  ...
  'pet.codexBundledTitle': 'Já vem com o Auto Design — sem download.',
  ...
  'updater.installerOpenBody': 'O instalador está aberto. Saia do Auto Design antes de substituir o app.',
  ...
  'updater.quitButton': 'Sair do Auto Design',
  'updater.quitFailedBody': 'Não foi possível sair do Auto Design.',
  ...
  'updater.readyVersion': 'Auto Design {version} está pronto.',
