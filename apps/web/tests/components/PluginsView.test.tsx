...
describe('PluginsView', () => {
    ...
    mockedListMarketplaces.mockResolvedValue([
      {
        ...
        trust: 'official',
        manifest: {
          name: 'Auto Design Official',
          version: '0.1.0',
          plugins: [{
            name: 'open-design/official-plugin',
            title: 'Official Plugin',
            source: 'github:aresbit/autoagent-design@main/plugins/_official/scenarios/official-plugin',
            version: '1.0.0',
  ...
  it('manages registry sources from the Sources tab', async () => {
    ...
    const sourceUrl =
      'https://raw.githubusercontent.com/aresbit/autoagent-design/main/plugins/registry/community/open-design-marketplace.json';
  ...
  it('confirms a plugin share action before starting the GitHub repo task', async () => {
    mockedListPlugins.mockResolvedValue([
      ...
      makePlugin(
        ...
        'Creates a public GitHub repository for a local Auto Design plugin using the GitHub CLI.',
      ),
      makePlugin(
        'od-plugin-contribute-open-design',
        'bundled',
        'bundled',
        'Contribute Plugin to Auto Design',
        'Opens a pull request that adds a local Auto Design plugin to the Auto Design community catalog.',
      ),
    ]);
