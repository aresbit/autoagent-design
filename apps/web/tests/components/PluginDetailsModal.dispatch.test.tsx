...
describe('PluginDetailsModal common metadata coverage', () => {
  ...
  it('routes official plugin author and source links to the Auto Design repo', () => {
    const html = render(
      pluginWithMeta({
    ...
    expect(html).toContain('href="https://github.com/aresbit/autoagent-design"');
    expect(html).toContain('aresbit/autoagent-design');
