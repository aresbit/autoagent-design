...
const REPO_TREE = 'https://github.com/aresbit/autoagent-design/tree/main';
const REPO_BLOB = 'https://github.com/aresbit/autoagent-design/blob/main';
...
export function shapeDesignTemplate(
  ...
  const summary =
    ...
    'Auto Design renderable design template.';
...
export function shapeLiveArtifactTemplate(
  ...
  const summary = extractFirstProseParagraph(body) || 'Auto Design Live Artifact template.';
