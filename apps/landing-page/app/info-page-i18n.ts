...
const INFO_PAGE_COPY: Partial<Record<LandingLocaleCode, InfoPageCopy>> = {
  en: {
    ...
    official: {
      title: 'Official Auto Design — Source page, GitHub, releases, and aliases',
      description:
        'Official source page for Auto Design (also searched as OpenDesign, open-design, opendesign, Auto Design AI, OD). Canonical site, GitHub repository, releases, Discord, license, and maintainer identity in one place.',
      breadcrumb: 'Official',
      label: 'Source · Nº 00',
      ...
      aliases: [
        { label: 'Auto Design', body: 'display name in the product UI, blog, and READMEs.' },
        ...
        { label: 'Auto Design AI', body: 'long-form search variant for AI-design queries.' },
    ...
    quickstart: {
      title: 'Auto Design quickstart — Install in three commands (Node 24, pnpm)',
      description:
        'Install Auto Design locally with three commands. Requirements (Node 24, pnpm 10.33.2), commands, expected output, troubleshooting, and how to generate your first design artifact with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen.',
      breadcrumb: 'Quickstart',
      label: 'Install · Nº 01',
      heading: 'Auto Design quickstart.',
      lead:
        'Auto Design runs entirely on your machine. Three commands gets you from a clean checkout to a running daemon, web UI, and your first generated design artifact.',
      ...
      nextItems: [
        ...
        { label: 'Compare Auto Design', body: 'with Claude Design, Figma Make, v0, and Lovable.' },
    ...
    agents: {
      title: 'Auto Design agents — 17 BYOK adapters',
      description:
        'Auto Design ships 17 BYOK adapters out of the box. Drive design from the same agent you use for code — no separate vendor login.',
      breadcrumb: 'Agents',
      label: 'Adapters · Nº 04',
      heading: (count) => `${count} BYOK agents, one skill protocol.`,
      lead: (count) =>
        `Auto Design ships ${count} first-party adapters out of the box. The same composable skills and portable DESIGN.md systems work with every one. BYOK throughout — your keys, your spend, your data.`,
      adaptersTitle: 'How adapters plug in',
      adaptersBody:
        'Every adapter is a thin shim between the agent native message format and Auto Design skill protocol. Adding a new adapter is a single file — no fork required.',
      tiers: [
        {
          label: 'Tier 1 — first-party tested',
          blurb:
            'Battle-tested daily by the Auto Design maintainers. Stream-JSON IPC where supported, full AskUserQuestion mid-turn, skill-aware system prompts.',
        },
        {
      ...
      byokLead: 'BYOK ("bring your own key") in Auto Design keeps credentials and spend on your side:',
      byokItems: [
      ...
      ctaBody:
        'Pick the agent already on your laptop, point Auto Design at it, and start rendering.',
    },
    compare: {
      title: 'Auto Design vs Claude Design, Figma Make, v0, Lovable — honest comparison',
      description:
        'Compare Auto Design to the major AI design tools. Hosted vs local-first, BYOK vs vendor-locked, single-shot generation vs portable DESIGN.md systems.',
      breadcrumb: 'Compare',
      label: 'Evaluation · Nº 02',
      heading: 'Auto Design vs everything else.',
      lead:
        'Short, honest summaries of how Auto Design relates to the other AI design tools you might be evaluating.',
      toc: ['vs Claude Design', 'vs Figma Make', 'vs v0', 'vs Lovable / Bolt', 'vs Open CoDesign', 'Honest limits'],
      comparisons: [
        {
          competitor: 'Claude Design',
          summary:
            'Hosted product tied to a single vendor. Auto Design is local-first, BYOK, and Apache-2.0 — your skills and DESIGN.md live in your repo.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Figma Make',
          summary:
            'Figma Make focuses on prompt-to-mockup inside Figma. Auto Design ships portable artifacts directly into your project.',
          cta: 'See the repo for migration notes ->',
        },
        {
          competitor: 'v0 by Vercel',
          summary:
            'v0 generates React components on a hosted runtime. Auto Design generates decks, dashboards, landing pages, and brand systems locally.',
          cta: 'See the repo for migration notes ->',
        },
        {
          competitor: 'Lovable / Bolt',
          summary:
            'Lovable and Bolt focus on hosted prompt-to-app. Auto Design is the design-skill layer for an agent you already use.',
          cta: 'See the repo for migration notes ->',
        },
        {
          competitor: 'Open CoDesign',
          summary:
            'Open CoDesign is a sibling open-source project. Auto Design can wrap codesign-style workflows through its skill protocol.',
          cta: 'See the repo for migration notes ->',
        },
      ],
      limitsTitle: "Honest limits — what Auto Design isn't",
      limitsBody:
        'Auto Design is not trying to be every hosted AI design tool. These questions describe the trade-offs instead of glossing them.',
      limitsFaq: [
        { name: 'Does Auto Design offer a hosted web sandbox?', text: 'No. Auto Design is local-first by design.' },
        { name: 'Can I use Auto Design without installing anything?', text: 'Not today. The minimum is a local daemon plus a coding agent.' },
        { name: 'Is Auto Design a v0 / Lovable / Bolt replacement?', text: 'It depends. Auto Design focuses on prompt-to-design-artifact via a skill protocol you can fork.' },
        { name: 'Does Auto Design send my data to Anthropic, OpenAI, or Google?', text: 'Only your prompt and skill context goes to the provider whose key you brought.' },
        { name: 'Can I self-host Auto Design on my own infrastructure?', text: 'Yes. Apache-2.0 license, Node 24 daemon, no required SaaS.' },
      ],
    },
    claudeAlternative: {
      title: 'Open-source Claude Design alternative — Auto Design (BYOK, local-first)',
      description:
        'Auto Design is the open-source, local-first alternative to Claude Design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen.',
      breadcrumb: 'Open-source Claude Design alternative',
      label: 'Alternative · Nº 03',
      heading: 'Open-source Claude Design alternative.',
      lead:
        'Auto Design is the official open-source, local-first alternative to Claude Design. BYOK with the agent you already use, keep your brand as a portable DESIGN.md file, and ship artifacts as files in your project.',
      tldrTitle: 'TL;DR',
      tldrBody:
      ...
      localByokBody: [
        'Auto Design runs a desktop app, a local daemon, and Markdown skill/system catalogs on your machine.',
      ...
      pickOpenTitle: 'Pick Auto Design if',
      pickOpen: [
      ...
      migrateSteps: [
        'Install Auto Design from the quickstart.',
      ...
      faqTitle: 'FAQ',
      faq: [
        { name: 'Is Auto Design really a drop-in alternative to Claude Design?', text: 'Not literally, but they overlap on prompt-to-design-artifact use cases.' },
        { name: 'Can I use Claude as my agent in Auto Design?', text: 'Yes. Auto Design supports Claude Code and Anthropic API BYOK flows.' },
...
INFO_PAGE_COPY.zh = {
  ...
  official: {
    ...
    title: '官方 Auto Design —— 来源页、GitHub、发布与别名',
    description:
      'Auto Design 官方来源页：canonical 网站、GitHub 仓库、发布、Discord、许可证和维护者身份都集中在这里。',
    breadcrumb: '官方',
    label: '来源 · Nº 00',
  ...
  quickstart: {
    ...
    title: 'Auto Design 快速开始 —— 三条命令安装（Node 24、pnpm）',
    description:
      '用三条命令在本地安装 Auto Design。包含 Node 24、pnpm 10.33.2 要求、命令、预期输出、排障和首次生成设计 artifact 的步骤。',
    breadcrumb: '快速开始',
    label: '安装 · Nº 01',
    heading: 'Auto Design 快速开始。',
    lead: 'Auto Design 完全运行在你的机器上。三条命令就能从干净 checkout 到本地 daemon、Web UI 和第一个设计 artifact。',
    ...
    nextItems: [
      ...
      { label: '比较 Auto Design', body: '了解它和 Claude Design、Figma Make、v0、Lovable 的差异。' },
  ...
  agents: {
    ...
    title: 'Auto Design Agent —— 17 个 BYOK 适配器',
    description: 'Auto Design 内置 17 个 BYOK 适配器。直接用你写代码时已经在用的 Agent 来驱动设计，无需额外厂商登录。',
    breadcrumb: 'Agent',
    label: '适配器 · Nº 04',
    heading: (count) => `${count} 个 BYOK Agent，一套 Skill 协议。`,
    lead: (count) =>
      `Auto Design 内置 ${count} 个一方适配器。同一套可组合 Skill 和可移植 DESIGN.md 系统可以用于每一个 Agent。全程 BYOK：你的密钥、你的成本、你的数据。`,
    adaptersTitle: '适配器如何接入',
    adaptersBody:
      '每个适配器都是很薄的一层 shim，把 Agent 原生消息格式翻译成 Auto Design Skill 协议。新增适配器通常只是一个文件，不需要 fork 整个产品。',
    tiers: [
      { label: 'Tier 1 —— 一方日常验证', blurb: 'Auto Design 维护者每天使用的适配器。支持时会使用 Stream-JSON IPC、AskUserQuestion 中途交互和 Skill-aware system prompt。' },
    ...
    byokLead: 'Auto Design 中的 BYOK（bring your own key）意味着凭据和成本都留在你这一侧：',
    byokItems: [
    ...
    ctaBody: '选择你电脑上已有的 Agent，把 Auto Design 指向它，然后开始渲染。',
  },
  compare: {
    ...INFO_PAGE_COPY.en!.compare,
    title: 'Auto Design vs Claude Design、Figma Make、v0、Lovable —— 诚实对比',
    description:
      '比较 Auto Design 与主流 AI 设计工具：云端托管 vs 本地优先、BYOK vs 厂商锁定、一次性生成 vs 可移植 DESIGN.md 系统。',
    breadcrumb: '对比',
    label: '评估 · Nº 02',
    heading: 'Auto Design 与其它工具的对比。',
    lead: '这里用简短、诚实的摘要说明 Auto Design 与你可能正在评估的其它 AI 设计工具之间的关系。',
    toc: ['vs Claude Design', 'vs Figma Make', 'vs v0', 'vs Lovable / Bolt', 'vs Open CoDesign', '真实限制'],
    comparisons: [
      { competitor: 'Claude Design', summary: '绑定单一厂商的云端产品。Auto Design 本地优先、BYOK、Apache-2.0，Skill 与 DESIGN.md 都留在你的 repo。', cta: '阅读完整对比 ->' },
      { competitor: 'Figma Make', summary: 'Figma Make 侧重在 Figma 内 prompt-to-mockup。Auto Design 把可移植 artifact 直接交付到你的项目。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'v0 by Vercel', summary: 'v0 在云端 runtime 生成 React 组件。Auto Design 在本地生成 deck、dashboard、landing page 和品牌系统。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'Lovable / Bolt', summary: 'Lovable 和 Bolt 侧重云端 prompt-to-app。Auto Design 是给你已有 Agent 使用的设计 Skill 层。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'Open CoDesign', summary: 'Open CoDesign 是同领域开源项目。Auto Design 可以通过 Skill 协议包装 codesign 类型工作流。', cta: '查看仓库中的迁移说明 ->' },
    ],
    limitsTitle: '真实限制 —— Auto Design 不是什么',
    limitsBody: 'Auto Design 不试图成为所有云端 AI 设计工具。下面的问题说明实际取舍，而不是把限制包装掉。',
    limitsFaq: [
      { name: 'Auto Design 有云端 Web sandbox 吗？', text: '没有。Auto Design 的设计目标就是本地优先。' },
      { name: '不安装任何东西可以使用 Auto Design 吗？', text: '目前不行。最小形态是本地 daemon 加一个 coding agent。' },
      { name: 'Auto Design 是 v0 / Lovable / Bolt 替代品吗？', text: '取决于场景。Auto Design 聚焦通过可 fork 的 Skill 协议生成设计 artifact。' },
      { name: 'Auto Design 会把我的数据发给 Anthropic、OpenAI 或 Google 吗？', text: '只会把 prompt 与 Skill 上下文发给你自己带 key 的 provider。' },
      { name: '可以把 Auto Design 自托管到自己的基础设施吗？', text: '可以。Apache-2.0、Node 24 daemon、没有必需 SaaS。' },
    ],
  },
  claudeAlternative: {
    ...INFO_PAGE_COPY.en!.claudeAlternative,
    title: 'Claude Design 开源替代方案 —— Auto Design（BYOK、本地优先）',
    description:
      'Auto Design 是 Claude Design 的开源、本地优先替代方案。支持 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 的 BYOK 工作流。',
    breadcrumb: 'Claude Design 开源替代方案',
    label: '替代方案 · Nº 03',
    heading: 'Claude Design 的开源替代方案。',
    lead:
      'Auto Design 是官方开源、本地优先的 Claude Design 替代方案。你可以用自己已有的 Agent BYOK，把品牌保存为可移植 DESIGN.md 文件，并把 artifact 作为项目文件交付。',
    tldrTitle: '简版结论',
    ...
    localByokBody: [
      'Auto Design 在你的机器上运行桌面应用、本地 daemon，以及 Markdown 形式的 Skill/System 目录。',
    ...
    pickOpenTitle: '适合 Auto Design 的情况',
    ...
    migrateSteps: ['按快速开始安装 Auto Design。', '打开 Web UI，让 Agent 查看一个你喜欢的 Claude Design artifact。', '让 Agent 把品牌提取成 DESIGN.md 文件。', '选择一个 Skill，用新品牌渲染。'],
    migrateClosing: '之后每个 Skill 都能沿用你的品牌，不需要反复重新提示。',
    faqTitle: 'FAQ',
    faq: [
      { name: 'Auto Design 真的是 Claude Design 的 drop-in 替代吗？', text: '不是字面上的 drop-in，但它们都覆盖 prompt-to-design-artifact 这个用途。' },
      { name: '可以在 Auto Design 中使用 Claude 作为 Agent 吗？', text: '可以。Auto Design 支持 Claude Code 和 Anthropic API BYOK。' },
...
INFO_PAGE_COPY['zh-tw'] = {
  ...
  official: {
    ...
    title: '官方 Auto Design —— 來源頁、GitHub、發布與別名',
    description:
      'Auto Design 官方來源頁：canonical 網站、GitHub repo、發布、Discord、授權與維護者身份都集中在這裡。',
    breadcrumb: '官方',
    ...
    aliases: [
      { label: 'Auto Design', body: '產品 UI、部落格與 README 中的展示名。' },
      ...
      { label: 'Auto Design AI', body: '用來區分通用 open design 話題的長尾搜尋詞。' },
  ...
  quickstart: {
    ...
    title: 'Auto Design 快速開始 —— 三條命令安裝（Node 24、pnpm）',
    description:
      '用三條命令在本地安裝 Auto Design。包含 Node 24、pnpm 10.33.2 要求、命令、預期輸出、排障與首次生成設計 artifact 的步驟。',
    breadcrumb: '快速開始',
    heading: 'Auto Design 快速開始。',
    lead: 'Auto Design 完全執行在你的機器上。三條命令就能從乾淨 checkout 到本地 daemon、Web UI 和第一個設計 artifact。',
  ...
  agents: {
    ...
    title: 'Auto Design Agent —— 17 個 BYOK adapter',
    description: 'Auto Design 內建 17 個 BYOK adapter。直接用你寫程式時已經在用的 Agent 來驅動設計，無需額外供應商登入。',
    breadcrumb: 'Agent',
    heading: (count) => `${count} 個 BYOK Agent，一套 Skill 協議。`,
    lead: (count) =>
      `Auto Design 內建 ${count} 個一方 adapter。同一套可組合 Skill 與可移植 DESIGN.md 系統可以用於每一個 Agent。全程 BYOK：你的密鑰、你的成本、你的資料。`,
    adaptersTitle: 'Adapter 如何接入',
    adaptersBody:
      '每個 adapter 都是很薄的一層 shim，把 Agent 原生訊息格式翻譯成 Auto Design Skill 協議。新增 adapter 通常只是一個檔案，不需要 fork 整個產品。',
    vendor: '供應商',
    credential: '憑據',
    byokTitle: '這裡的 BYOK 是什麼意思',
    byokLead: 'Auto Design 中的 BYOK（bring your own key）意味著憑據和成本都留在你這一側：',
    byokItems: [
    ...
    ctaBody: '選擇你電腦上已有的 Agent，把 Auto Design 指向它，然後開始渲染。',
  },
  compare: {
    ...INFO_PAGE_COPY.zh!.compare,
    title: 'Auto Design vs Claude Design、Figma Make、v0、Lovable —— 誠實比較',
    breadcrumb: '比較',
    label: '評估 · Nº 02',
    heading: 'Auto Design 與其他工具的比較。',
    lead: '這裡用簡短、誠實的摘要說明 Auto Design 與你可能正在評估的其他 AI 設計工具之間的關係。',
    limitsTitle: '真實限制 —— Auto Design 不是什麼',
    limitsBody: 'Auto Design 不試圖成為所有雲端 AI 設計工具。下面的問題說明實際取捨，而不是把限制包裝掉。',
  },
  claudeAlternative: {
    ...INFO_PAGE_COPY.zh!.claudeAlternative,
    title: 'Claude Design 開源替代方案 —— Auto Design（BYOK、本地優先）',
    description:
      'Auto Design 是 Claude Design 的開源、本地優先替代方案。支援 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 的 BYOK 工作流。',
    breadcrumb: 'Claude Design 開源替代方案',
    label: '替代方案 · Nº 03',
    heading: 'Claude Design 的開源替代方案。',
    lead:
      'Auto Design 是官方開源、本地優先的 Claude Design 替代方案。你可以用自己已有的 Agent BYOK，把品牌保存為可移植 DESIGN.md 檔案，並把 artifact 作為專案檔案交付。',
    tldrTitle: '簡版結論',
    ...
    pickOpenTitle: '適合 Auto Design 的情況',
    migrateTitle: '遷移 / 首次執行',
    faqTitle: 'FAQ',
    faq: [
      { name: 'Auto Design 真的是 Claude Design 的 drop-in 替代嗎？', text: '不是字面上的 drop-in，但它們都覆蓋 prompt-to-design-artifact 這個用途。' },
      { name: '可以在 Auto Design 中使用 Claude 作為 Agent 嗎？', text: '可以。Auto Design 支援 Claude Code 和 Anthropic API BYOK。' },
...
> = {
  ja: {
    ...
    reusable: {
      sourceBody: 'この項目は Auto Design の正規の入口と同じプロジェクトを指します。',
    ...
    official: {
      title: '公式 Auto Design — 出典、GitHub、リリース、別名',
      description: 'Auto Design の正規ページ、GitHub、リリース、コミュニティ、ライセンスをまとめた確認用ページです。',
      breadcrumb: '公式',
      label: '出典 · Nº 00',
    ...
    quickstart: {
      ...
      description: 'Auto Design をローカルに入れ、daemon、Web UI、最初の artifact まで進む手順です。',
      breadcrumb: 'クイックスタート',
      label: 'インストール · Nº 01',
      heading: 'Auto Design クイックスタート。',
      lead: 'ローカル環境だけで起動し、既存のエージェントからデザイン生成を始められます。',
      ctaTitle: 'ローカルで始める。',
    },
    agents: {
      title: 'Auto Design エージェント — {count} 個の BYOK アダプター',
      description: '普段使っているコーディングエージェントから Auto Design のスキルを実行できます。',
      breadcrumb: 'エージェント',
      label: 'アダプター · Nº 04',
      heading: '{count} 個の BYOK エージェント、1 つのスキルプロトコル。',
      lead: 'Auto Design は {count} 個のアダプターで、同じスキルと DESIGN.md を複数のエージェントから使えます。',
      ctaTitle: '{count} 個のアダプター。あなたのエージェント。',
    },
    compare: {
      title: 'Auto Design と主要 AI デザインツールの比較',
      description: 'ローカル優先、BYOK、オープンソース、ポータブルな DESIGN.md という観点で比較します。',
      breadcrumb: '比較',
      label: '評価 · Nº 02',
      heading: 'Auto Design と他の選択肢。',
      lead: 'Auto Design はホスト型ツールではなく、エージェントで動かすローカル優先のデザイン層です。',
    },
    claudeAlternative: {
      title: 'Claude Design のオープンソース代替 — Auto Design',
      description: 'Auto Design は BYOK とローカル優先を軸にした Claude Design 代替です。',
...
function compactInfoTextFromHome(locale: LandingLocaleCode): CompactInfoPageText {
  ...
  return {
    ...
    official: {
      title: `${labels.official} · Auto Design`,
      description: summary,
      breadcrumb: labels.official,
      label: labels.official,
      heading: `${labels.official} · Auto Design`,
      lead,
    },
    quickstart: {
      title: `${labels.quickstart} · Auto Design`,
      description: lead,
      breadcrumb: labels.quickstart,
      label: labels.quickstart,
      heading: `${labels.quickstart} · Auto Design`,
      lead,
      ctaTitle: labels.next,
    },
    agents: {
      title: `${labels.agents} · Auto Design`,
      description: lead,
    ...
    compare: {
      title: `${labels.compare} · Auto Design`,
      description: summary,
      breadcrumb: labels.compare,
      label: labels.compare,
      heading: `${labels.compare} · Auto Design`,
      lead,
    },
    claudeAlternative: {
      title: `${labels.alternative} · Auto Design`,
      description: summary,
      breadcrumb: labels.alternative,
      label: labels.alternative,
      heading: `${labels.alternative} · Auto Design`,
