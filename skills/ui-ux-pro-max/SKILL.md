...
## Current Auto Design scope

Auto Design currently ships this entry as discovery metadata only. If this `SKILL.md`
...
If those upstream files are not installed, explain that Auto Design only has the
catalog entry for this skill and ask whether to continue with Auto Design's
