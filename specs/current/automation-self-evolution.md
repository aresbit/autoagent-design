...
Automations should become the product-wide loop that lets Auto Design improve
...
Auto Design becomes a self-evolving design agent when every useful run can
