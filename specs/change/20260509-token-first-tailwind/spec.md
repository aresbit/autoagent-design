...
- Decision: clear Tailwind's default color namespace with `--color-*: initial` before declaring project colors, so project classes express the Auto Design token set. Source: `https://tailwindcss.com/docs/customizing-colors`; `apps/web/src/index.css:6-49`
...
Goal: add Tailwind v4 infrastructure, expose Auto Design tokens as Tailwind utilities, and land the first style guard scaffolding.
...
- [x] Step 2: Expose Auto Design tokens as Tailwind utilities
