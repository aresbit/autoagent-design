...
description: A portable community plugin for validating Auto Design plugin import flows.
---

# Community Import Smoke Test

Use this plugin when validating that Auto Design can import community plugins
