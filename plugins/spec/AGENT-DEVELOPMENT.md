...
Give this file to a coding agent when you want it to create or improve an Auto Design plugin.

## Mission

Create a portable Auto Design plugin that can:

1. Run as a normal Agent Skill through `SKILL.md`.
2. Install into Auto Design through `open-design.json`.
3. Be validated locally.
4. Be published as an independent open source repo or submitted as a PR to Auto Design.
...
- `plugins/spec/PUBLISHING-REGISTRIES.md` when the user asks to publish outside Auto Design
...
3. Keep the `SKILL.md` portable. It may mention Auto Design behavior, but the core workflow must still make sense in any Agent Skills compatible agent.
