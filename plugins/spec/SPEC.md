# Auto Design Plugin Spec

Language: English | [简体中文](SPEC.zh-CN.md)

This spec is the compact contract for portable Auto Design plugins. The canonical product spec remains `docs/plugins-spec.md`; this document is optimized for contributors and external coding agents.
...
## 2. Enriched Auto Design Plugin

Add `open-design.json` when the plugin should appear in Auto Design as a marketplace card or starter:
...
- `specVersion` is the Auto Design plugin spec version that this manifest follows. Use the current spec kit value (`1.0.0`) unless the schema moves.
