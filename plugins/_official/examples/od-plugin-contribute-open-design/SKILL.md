...
description: Open a pull request adding a local Auto Design plugin to the Auto Design community catalog using gh CLI.
triggers:
  - contribute plugin
  - auto design pr
  - github pull request
...
Use this workflow when the active project contains a copied plugin folder and the user wants to propose it for the Auto Design community catalog.
...
Keep the pull request focused. Do not modify unrelated Auto Design files unless a manifest validation issue requires a tiny supporting change.
