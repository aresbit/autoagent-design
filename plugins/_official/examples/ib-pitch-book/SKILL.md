...
repackaged as an Auto Design `deck` skill.
...
Follow Auto Design's deck export path for the active session (HTML / PDF /
PPTX per daemon capabilities).

## Relationship to Auto Design financial skills
...
original adaptation for Auto Design.
