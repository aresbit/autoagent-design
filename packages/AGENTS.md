...
- `packages/sidecar-proto`: Auto Design sidecar business protocol. Owns app/mode/source constants, namespace validation, stamp descriptor/fields/flags, IPC message schema, status shapes, error semantics, and default product path constants.
...
- Do not hard-code Auto Design app/source/mode constants in `sidecar` or `platform`.
